...
namespace ForecastUI
{
    public class Weather
    {
        ...
        {
            return $"T={this.GetTemperature()}°C, w={this.GetWindSpeed()}km/h, h={this.GetHumidity()}%";
        }
        #endregion

        #region Operators
        public static bool operator >(Weather leftWeather, Weather rightWeather)
        {
            return leftWeather.GetTemperature() > rightWeather.GetTemperature();
        }
